...
$('document').ready(function(){
	...
	$('#wish_message').click(function(){
		...
		// $('#b6').attr('id','b66');
		// $('#b7').attr('id','b77');
		$('#b11').animate({top:250, left: vw-100},500);
		$('#b22').animate({top:250, left: vw-50},500);
		$('#b33').animate({top:250, left: vw},500);
		$('#b44').animate({top:250, left: vw+50},500);
		$('#b55').animate({top:250, left: vw+100},500);
		// $('#b66').animate({top:240, left: vw+150},500);
		// $('#b77').animate({top:240, left: vw+250},500);
